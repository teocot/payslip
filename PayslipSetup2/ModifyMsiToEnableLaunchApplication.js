...
var filename = "PayslipDesktop.exe";       // The name of the executable to launch - change this to match the file you want to launch at the end of your setup
...
try
{
        ...
        sql = "INSERT INTO `Control` (`Dialog_`, `Control`, `Type`, `X`, `Y`, `Width`, `Height`, `Attributes`, `Property`, `Text`, `Control_Next`, `Help`) VALUES ('FinishedForm', 'CheckboxLaunch', 'CheckBox', '9', '203', '143', '12', '3', 'LAUNCHAPP', '{\\VSI_MS_Sans_Serif18.0_0_0}" + checkboxText + "', 'CloseButton', '|')";
        view = database.OpenView(sql);
        view.Execute();
        view.Close();
